<template>
    <app-layout>
            ...
            <div class="compu">
                <div style="display: flex; justify-content: center; padding-top: 17px; text-align: center; position: center;">
                    <div v-for="cat in categorias" :key="cat.id" style="text-align: center; position: center;" >
                        <button v-if="cat.titulo != categoria"  @click="buscarCategoria(cat.titulo)"  type="submit" class="button"  style="background-color: #3d107b; border-color: white; padding: 0.35rem 0.75rem; float: left; margin-right: 10px; ">
                            {{cat.titulo}}
                        </button>
                        <button v-if="cat.titulo == categoria"  @click="buscarCategoria(cat.titulo)"  type="submit" class="button"  style="background-color: white; color: black; border-color: white; padding: 0.35rem 0.75rem; float: left; margin-right: 10px; ">
                            {{cat.titulo}}
                        </button>
                    </div>
                </div>
        ...
        <div class="py-12">
              <div>
                  <div style="margin-bottom: 3%">
                      <div v-if="categoria != 'Servicios' && categoria != 'Inmuebles'" class="buttons" style="margin-bottom: 30px">
                          <button @click="filtrarProductos(1)"  style="margin-right: 40px; margin-bottom: 0px; width: 150px" class="blob-btn">
                              <p style="font-size: 15px">Precio</p>
                              <p style="font-size: 10px">(Mayor a Menor)</p>
        ...
        <span class="blob-btn__blobs">
          ...
          <span class="blob-btn__blob"></span>
                          ...
                          <button @click="filtrarProductos(2)" style="margin-right: 40px; margin-bottom: 0px;  width: 150px" class="blob-btn">
                              <p style="font-size: 15px">Precio</p>
                              <p style="font-size: 10px">(Menor a Mayor)</p>
                              <span class="blob-btn__inner">
        <span class="blob-btn__blobs">
          <span class="blob-btn__blob"></span>
          <span class="blob-btn__blob"></span>
          ...
          <span class="blob-btn__blob"></span>
                          ...
                          <button @click="filtrarProductos(3)"  class="blob-btn" style="margin-right: 40px; margin-bottom: 0px;  width: 150px">
                              <p style="font-size: 15px">Usado</p>
                        ...
                        <span class="blob-btn__blobs">
                          ...
                          <button @click="filtrarProductos(4)"  class="blob-btn" style="margin-right: 40px; margin-bottom: 0px;  width: 150px">
                              <p style="font-size: 15px">Nuevo</p>
                              <p style="font-size: 10px">(Estado)</p>
                              <span class="blob-btn__inner">
                        <span class="blob-btn__blobs">
                          <span class="blob-btn__blob"></span>
                          ...
                          <button @click="filtrarProductos(5)"  class="blob-btn" style="margin-right: 40px; margin-bottom: 0px;  width: 150px">
                              <p style="font-size: 15px">A - Z</p>
                      ...
                      <div v-if="categoria == 'Inmuebles'" class="buttons" style="margin-bottom: 30px">
                          <button @click="filtrarProductos(1)"  style="margin-right: 40px; margin-bottom: 0px; width: 150px" class="blob-btn">
                              <p style="font-size: 15px">Alquiler</p>
                              <p style="font-size: 10px">(En Usd)</p>
                              <span class="blob-btn__inner">
        <span class="blob-btn__blobs">
          <span class="blob-btn__blob"></span>
          <span class="blob-btn__blob"></span>
          ...
          <span class="blob-btn__blob"></span>
                          ...
                          <button @click="filtrarProductos(2)" style="margin-right: 40px; margin-bottom: 0px;  width: 150px" class="blob-btn">
                              <p style="font-size: 15px">Venta</p>
                              <p style="font-size: 10px">(En Usd)</p>
                              <span class="blob-btn__inner">
        <span class="blob-btn__blobs">
          <span class="blob-btn__blob"></span>
          ...
          <span class="blob-btn__blob"></span>
                      ...
                      <div  v-for="pub in productos" :key="pub.id">
                        <div id="container" style="float: left; margin-right: 10px;">
                          <div v-if="categoria != 'Servicios' && categoria != 'Inmuebles'" style="background-color: #007cc2">
                                      ...
                                      <div style="">
                                          <div class="botonesAbajo">
                                              <button style="width: 100%">
                                                  <a style="margin-bottom: 10px" :href="'https://api.whatsapp.com/send?phone=54' + pub.celular + '&text=' + 'Hola%20' + pub.name + ',%20¿Como%20estas?%0ASoy%20' + pub.miNombre + '.%20%0AVi%20tu%20publicacion%20llamada%20' + pub.titulo + '%20en%20ColeMarket%20y%20estoy%20interesado.'" target="_blank">
                          ...
                          <div v-if="categoria == 'Servicios'" style="background-color: #007cc2">
                              <div style="height: 200px; z-index:0;">
                                  <img :src="'/market/' + pub.path2[0].path + '.jpg'" style="min-height: 200px">
                              </div>
                              <div style="z-index:1;">
                                  <div class="product-details"  style="background-color: white">
                                      <h1 style="position: center; font-size: 40px; margin-bottom: 15px">{{pub.titulo}} </h1>
                                      <p style="font-size: 18px; margin-bottom: 10px"><b>Nombre: </b>{{pub.nombre}} </p>
                                      <p style="font-size: 18px; margin-bottom: 10px"><b>Celular: </b>{{pub.numero}} </p>
                                      <p style="font-size: 18px; margin-bottom: 10px"><b>Direccion: </b>{{pub.direccion}} </p>
                                  </div>
                              </div>
                          </div>
                          <div v-if="categoria == 'Inmuebles'" style="background-color: #007cc2">
                              <div style="height: 200px; z-index:0;">
        ...
        <div class="modal  fade"  id="Modal2" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
          ...
          <div class="modal  fade"  id="Modal3" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" style=" margin-top: 3%">
                  <div class="modal-content ">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="red" class="bi bi-x-square-fill" viewBox="0 0 16 16">
                          <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm3.354 4.646L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 1 1 .708-.708z"/>
                      ...
                      <div class="modal-body">
                          <div v-for="(pre,key) in fotos">
                                  <img :src="'/market/' + pre.path + '.jpg'"  style="width: 90%; position: center; margin: 5%; border:10px outset #5B5B5B;">
                          </div>
                          <button  @click="cambiarFotos()"  style="width: 50%; margin-left: 25%; background-color: #A9CCFF; font-size: 20px; border-radius: 5px; margin-top: 40px;  margin-bottom: 20px">Ver más imágenes</button>
                          <div v-for="(foto, key) in pub.path2" v-if="verFotos">
                              <img :src="'/market/' + foto.path + '.jpg'" style="width: 70%; margin-left:15%;    border: 5px solid black;   border-radius: 25px; margin-bottom: 15px;">
  ...
  export default {
      name: "Publicaciones",
      props: ['categoria','productos', 'categorias', 'sectores'],
      components: {
          Button,
          AppLayout,
          Welcome,
      ...
      methods:
          {
              ...
              filtrarProductos($tipo){
                  this.form2.tipo = $tipo;
                  this.$inertia.post('/filtrarProductos', this.form2);
              },
          }
  }
