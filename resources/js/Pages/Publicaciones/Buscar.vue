        ...
        <div class="py-12">
            <div>
                <div style="margin-bottom: 3%">
                    <h1 style="text-align: center; font-size: 70px; margin-bottom: 2%">Resultados</h1>
                    <div id="container" v-for="pub in total" :key="pub.id" style="float: left; margin-right: 10px">
                        <div v-if="pub.cate == 0" style="background-color: #007cc2">
                        ...
                        <div v-if="pub.cate == 2" style="background-color: #007cc2">
                            <div style="height: 200px; z-index:0;">
                                <img :src="'/market/' + pub.path2[0].path + '.jpg'" style="min-height: 200px">
                            </div>
                            <div style="z-index:1;">
                        ...
                        <div  v-if="pub.cate == 1" style="background-color: #007cc2">
                            <div style="height: 200px; z-index:0;">
